...
# Create an S3 bucket and enable Transfer Acceleration.
# Usage: ./s3-create-transfer-acceleration.sh [-p profile] [-r region] <bucket-name>
...
echo "Creating bucket with Transfer Acceleration: $BUCKET"
create_bucket "$BUCKET"
wait_bucket "$BUCKET"
enable_transfer_acceleration "$BUCKET" || { echo "Note: Transfer Acceleration may not be supported in all regions."; }
