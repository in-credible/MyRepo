...
# Create an S3 bucket with Requester Pays enabled.
# Usage: ./s3-create-requester-pays.sh [-p profile] [-r region] <bucket-name>
...
echo "Creating Requester Pays bucket: $BUCKET"
create_bucket "$BUCKET"
wait_bucket "$BUCKET"
enable_requester_pays "$BUCKET"
