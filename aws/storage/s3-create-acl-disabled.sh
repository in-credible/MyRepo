...
# Create an S3 bucket with ACLs disabled (BucketOwnerEnforced) and public access blocked.
# Usage: ./s3-create-acl-disabled.sh [-p profile] [-r region] <bucket-name>
...
echo "Creating bucket with ACLs disabled: $BUCKET"
create_bucket "$BUCKET"
wait_bucket "$BUCKET"
disable_acls_bucket_owner_enforced "$BUCKET"
